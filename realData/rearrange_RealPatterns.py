...
plt.ylabel("Number of hits")
plt.savefig(append+"histogram_alllayers_realData.png")
#plt.show()
...
plt.xlabel("Uniform Bins")
plt.ylabel("Number of hits")
plt.savefig(append+"histogram_layerA_realData.png")
#plt.show()
...
plt.xlabel("Uniform Bins")
plt.ylabel("Number of hits")
plt.savefig(append+"histogram_layerB_realData.png")
#plt.show()
...
plt.xlabel("Uniform Bins")
plt.ylabel("Number of hits")
plt.savefig(append+"histogram_layerC_realData.png")
#plt.show()
...
plt.xlabel("Uniform Bins")
plt.ylabel("Number of hits")
plt.savefig(append+"histogram_layerD_realData.png")
#plt.show()
